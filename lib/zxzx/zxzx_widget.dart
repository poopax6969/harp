...
import 'zxzx_model.dart';
export 'zxzx_model.dart';

class ZxzxWidget extends StatefulWidget {
  const ZxzxWidget({super.key});

  @override
  State<ZxzxWidget> createState() => _ZxzxWidgetState();
}

class _ZxzxWidgetState extends State<ZxzxWidget> {
  late ZxzxModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ZxzxModel());
                                  ...
                                  child: Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if ((_model.apiResultuok3?.succeeded ??
                                            true)) {
                                          ScaffoldMessenger.of(context)
                                              .showSnackBar(
                                            SnackBar(
                                    ...
                                    children: [
                                      ...
                                      ClipRRect(
                                        borderRadius:
                                            BorderRadius.circular(8.0),
                                        child: Image.network(
                                          (_model.apiResultuok3?.succeeded ??
                                                  true)
                                              ? getJsonField(
                                                  (_model.apiResultuok3
                                                          ?.jsonBody ??
